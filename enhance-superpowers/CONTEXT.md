...
| finish-spec-pr Step 6 (PR 作成後) | **builtin `/review` invoke** + GitHub 上の CodeRabbit 併読 | PR レビュー。指摘があれば user 1 問確認のうえ write-review-response へ折り返す (ADR-0015 D2) |
...
- **PR 作成後**: builtin `/review` (PR 専用・Skill tool から invoke 可・read-only) + GitHub 上の CodeRabbit
