...
Accepted (2026-06-25). Updated (2026-07-02): ADR-0011 で 5 成果物の生成順が plan-last (`summary → design → gwt → pr-description → plan`) に変わったため、下記 Phase → 追記先 mapping の Phase 番号を更新 (追記先の file 単位マッピング自体は不変)。
