...
**Superseded by root [ADR-0010](../../../docs/adr/0010-shared-as-plugin-agent-namespace.md)** (2026-07-28)：vendoring 廃止に伴い「どれを取り込むか」という選定自体が消滅し、`shared` plugin が 13 体すべてを提供する。dispatch は `shared:<agent>` の修飾名で行う。以下は vendoring 時代の判断記録。
