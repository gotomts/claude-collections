...
**Superseded by [ADR-0010](0010-shared-as-plugin-agent-namespace.md)** (2026-07-28)。`shared/` の plugin 化に伴い skill も単一実体で配る方式に移行し、vendoring を廃止した。本 ADR が想定した「collection 側で固有拡張を入れる余地」は実際には一度も使われなかった。
